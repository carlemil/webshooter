...
class MockPatrols {
    val patrols = listOf(
        PatrolEntry(
            id = 1, sortorder = 1, startTimeHuman = "08:00", endTimeHuman = "09:30",             signups = listOf(
        ...
        PatrolEntry(
            id = 2, sortorder = 2, startTimeHuman = "09:30", endTimeHuman = "11:00",             signups = listOf(
        ...
        PatrolEntry(
            id = 3, sortorder = 3, startTimeHuman = "11:00", endTimeHuman = "12:30",             signups = listOf(
        ...
        PatrolEntry(
            id = 4, sortorder = 4, startTimeHuman = "12:30", endTimeHuman = "14:00",             signups = listOf(
        ...
        PatrolEntry(
            id = 5, sortorder = 5, startTimeHuman = "14:00", endTimeHuman = "15:30",             signups = listOf(
