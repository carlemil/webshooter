...
fun CompetitionEntity.toDomain(gson: Gson): Datum = Datum(
    id = id,
    championshipsID = 0,
    isPublic = isPublic,
    resultsIsPublic = resultsIsPublic,
    ...
    finalTime = finalTime ?: "",
    createdBy = 0,
    pdfLogo = if (pdfLogo != null) gson.fromJson(pdfLogo, Logo::class.java) else Logo.Webshooter,
    weaponGroups = gson.fromJson(weaponGroupsJson, object : TypeToken<List<WeaponGroup>>() {}.type),
    signupsCount = signupsCount,
    patrolsCount = patrolsCount,
    status = status,
    statusHuman = statusHuman,
    ...
    finalTimeHuman = finalTimeHuman ?: "",
    allowSignupsAfterClosingDateHuman = allowSignupsAfterClosingDateHuman ?: "",
    translations = if (translationsJson != null) gson.fromJson(translationsJson, Translations::class.java) else Translations("","","","","","","","","","","","","",""),
    resultsTypeHuman = resultsTypeHuman ?: "",
    availableLogos = gson.fromJson(availableLogosJson, object : TypeToken<List<Logo>>() {}.type),
    pdfLogoPath = pdfLogoPath ?: "",
    pdfLogoURL = pdfLogoUrl ?: "",
    competitionType = gson.fromJson(competitionTypeJson, CompetitionType::class.java),
    weaponClasses = gson.fromJson(weaponClassesJson, object : TypeToken<List<WeaponClass>>() {}.type),
    userSignups = gson.fromJson(userSignupsJson, object : TypeToken<List<Usersignup>>() {}.type),
