...
/**
 * Renders a rounded badge showing a weapon group name, with visual variations for highlighted state and size.
 *
 * @param weaponGroupName The text displayed inside the badge.
 * @param isHighlighted If `true`, the badge uses the primary color scheme (highlighted appearance); if `false`, it uses the secondary color scheme.
 * @param size The badge size which controls typography and internal padding.
 */
@Composable
